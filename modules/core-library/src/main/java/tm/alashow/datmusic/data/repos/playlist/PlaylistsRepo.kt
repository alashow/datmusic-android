...
import tm.alashow.datmusic.data.repos.playlist.ArtworkImageFileType.Companion.isAutoGeneratedArtworkPath
...
class PlaylistsRepo @Inject constructor(
    ...
    private fun generatePlaylistArtwork(playlistId: PlaylistId, maxArtworksNeeded: Int = 4) {
        launch(dispatchers.computation) {
            ...
            if (playlist.artworkPath.isAutoGeneratedArtworkPath()) {
